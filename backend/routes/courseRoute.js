...
router
  ...
  .get(isAuthenticatedUser, authorizeRoles("instructor"), getInstructorCourses);

router
  .route("/instructor/courses/:courseId")
  .get(isAuthenticatedUser, authorizeRoles("instructor"), getInstructorCourse);
...
router
  ...
  .post(isAuthenticatedUser, authorizeRoles("instructor"), addSection);

router
  .route("/instructor/courses/:courseId/sections/:sectionId")
  .put(isAuthenticatedUser, authorizeRoles("instructor"), updateSection);

router
  .route("/instructor/courses/:courseId/sections/:sectionId")
  .delete(isAuthenticatedUser, authorizeRoles("instructor"), deleteSection);

router
  .route("/instructor/:courseId/:sectionId/uploads/video")
  .post(isAuthenticatedUser, authorizeRoles("instructor"), uploadVideo);

router
  .route("/courses/:courseId/enroll")
  .post(isAuthenticatedUser, authorizeRoles("student"), enrollInCourse);
